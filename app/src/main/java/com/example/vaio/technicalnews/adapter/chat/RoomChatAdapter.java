...
public class RoomChatAdapter extends RecyclerView.Adapter<RoomChatAdapter.ViewHolder> {
    private ArrayList<ChatRoom> arrRoomChat;
    private AccountManager accountManager;
    public RoomChatAdapter(ArrayList<ChatRoom> arrRoomChat, AccountManager accountManager) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.tvArea.setText(arrRoomChat.get(position).getName());
